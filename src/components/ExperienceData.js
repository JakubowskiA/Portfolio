export const experienceData = [
  ...
  },
  {
    ...
    description: [
      "Redesigned facilities using AutoCAD and Autodesk Inventor",
      "Investigated product defects and implemented corrective actions",
      "Standardized and improved manufacturing processes, reducing rejected product and process duration by 8%",
      "Managed $2M projects, including scope, schedule, and cost, saving $52M in expected loss",
      "Supervised contractors and technicians",
    ],
  },
  {
    companyName: "Legrand",
    ...
    description: [
      "Created Product Environmental Profiles",
      "Documented design changes to products and packaging",
      "Updated CAD models of products",
      "Participated in prodct safety testing",
    ],
  },
  {
    companyName: "Cisco",
  ...
  },
  {
    ...
    description: [
      "Organized and maintained database",
      "Reconciled financial documentation and prepared financial reports for medical trials",
    ],
  },
];
