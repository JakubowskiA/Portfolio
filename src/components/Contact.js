          ...
          <a href="Resume.pdf">
            <div className="contact-icon hvr-grow hvr-hide">
              <img
                ...
                src="https://icon-library.net/images/document-icon-image/document-icon-image-27.jpg"
              />
            </div>
        ...
        <div className="contact contact-div">
          <a href="https://github.com/JakubowskiA">
            <div className="contact-icon hvr-grow hvr-hide">
              <img
                className="contact-icon-img"
                src="https://icon-library.net/images/github-svg-icon/github-svg-icon-3.jpg"
              />
            </div>
        ...
        <div className="contact contact-div">
          <a className="mailto" href="mailto:arieljakubowski@gmail.com">
            <div className="contact-icon hvr-grow hvr-hide">
              <img
                className="contact-icon-img"
                src="https://image.flaticon.com/icons/svg/33/33700.svg"
              />
            </div>
